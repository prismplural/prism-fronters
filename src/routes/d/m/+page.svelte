...
<main class="container info">
    ...
    <section class="content">
        <div class="row">
            <input style="flex: 1;" readonly value={visibleUrl}/> <a class="button" href={gotoUrl} target="_blank" rel="noreferrer">View</a>      
        </div>
        <label for="d-mid">Enter a member id to generate a fake Discord profile for that member.</label>
            <div class="row" style="margin-bottom: 1rem;">
                <input required id="d-mid" name="mid" placeholder="member id..." on:input={(event) => updateMid(event.target?.value)}>
            </div>
            ...
            <div class="row" style="align-items: center;">
                <label for="d-prns">Show note (pronouns)</label> <input type="checkbox" id="d-prns" name="prns" bind:checked={showNote}>
            </div>
            <div class="row" style="align-items: center;">
                <label for="d-join">Show join date (birthday/created)</label> <input type="checkbox" id="d-join" name="join" bind:checked={showJoin}>
            </div>
            <div class="row" style="align-items: center; margin-bottom: 1rem;">
                <label for="d-group">Show roles (groups)</label> <input type="checkbox" id="d-group" name="group" bind:checked={showGroups}>
            </div>
            <hr style="width: 100%;"/>
            <h2>Hide certain sections</h2>
            <div class="row" style="align-items: center;">
                <label for="d-desc">Hide about me (description)</label> <input type="checkbox" id="d-desc" name="desc" bind:checked={hideDesc}>
            </div>
            <div class="row" style="align-items: center; margin-bottom: 1rem;">
                <label for="d-banner">Hide banner</label> <input type="checkbox" id="d-banner" name="banner" bind:checked={hideBanner}>
            </div>
            <hr style="width: 100%;"/>
            <h2>Misc options</h2>
            <div class="row" style="align-items: center;">
                <label for="d-nitro">Use Nitro gradient</label> <input type="checkbox" id="d-nitro" name="nitro" bind:checked={useNitro}>
            </div>
            <details style="width:100%; margin:1rem;">
                ...
                <div class="row" style="margin: 0.5rem;">
                    ...
                    <input id="d-sc" name="sc" placeholder="secondary hex color..." bind:value={secondaryColor}>
            ...
            <div class="row" style="margin: 1rem;">
                ...
                <input id="d-cut" name="cut" type="number" on:input={() => generateUrl(mid)} bind:value={descCutoff}>
            </div>
            <div class="row" style="margin-bottom: 0.5rem;">
